 ...
 * Resilience4J Module
 * <p>
 * This module decorates the feign invocations with Resilience4J.
 */
public class Resilience4JExtension implements PrimeExtension {
    ...
    public Resilience4JExtension() {
        this(null, null, null, null, null);
    }

    @Builder
    public Resilience4JExtension(MeterRegistry meterRegistry, BulkheadConfig bulkheadConfig, RateLimiterConfig rateLimiterConfig, CircuitBreakerConfig circuitBreakerConfig, RetryConfig retryConfig) {
